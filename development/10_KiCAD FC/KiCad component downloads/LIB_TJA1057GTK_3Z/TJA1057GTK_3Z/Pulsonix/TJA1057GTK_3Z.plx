...
(library Library_1
	...
	(compDef "TJA1057GTK_3Z" (originalName "TJA1057GTK_3Z") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "9" (pinName "EPAD") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "VIO") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.nxp.com/docs/en/data-sheet/TJA1057.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "TJA1057GTK_3Z.stp")
